...
class NewsEventScreen extends StatefulWidget {
  static const String routeName = '/news-event';
  final String? title;
  const NewsEventScreen({super.key, this.title});

  @override
  State<NewsEventScreen> createState() => NewsEventScreenState();
}

class NewsEventScreenState extends State<NewsEventScreen> {
